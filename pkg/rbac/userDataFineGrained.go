...
func (user *UserDataCache) getUserPermissions(ctx context.Context) (clusterviewv1alpha1.UserPermissionList, error) {
	// Get userpermissions.clusterview.open-cluster-management.io
	...
	if err != nil {
		...
		return clusterviewv1alpha1.UserPermissionList{}, err
	}
