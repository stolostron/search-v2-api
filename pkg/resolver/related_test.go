...
func Test_SearchResolver_Relationships(t *testing.T) {
	...
	propTypesMock := map[string]string{"uid": "string"}
	...
	resolver, mockPool2 := newMockSearchResolver(t, searchInput, resultList, &ud, propTypesMock)
...
func Test_SearchResolver_RelatedKindsRelationships(t *testing.T) {
	...
	resolver, mockPool2 := newMockSearchResolver(t, searchInput2, resultList, &ud, propTypesMock)
