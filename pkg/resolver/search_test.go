...
func Test_SearchResolver_ItemsWithDateOperator(t *testing.T) {
	...
	rbac := buildRbacWhereClause(context.WithValue(context.Background(), rbac.ContextAuthTokenKey, "123456"), &rbac.UserData{CsResources: csres, NsResources: nsres, ManagedClusters: mc})
	val8 := "year"
