...
type QueryResolver interface {
	GlobalSearch(ctx context.Context, input []*model.SearchInput) ([]*model.SearchResult, error)
...
func (ec *executionContext) _Query_globalSearch(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOSearchResult2ᚕᚖgithubᚗcomᚋstolostronᚋsearchᚑv2ᚑapiᚋfederatedsearchᚋgraphᚋmodelᚐSearchResult(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputSearchInput(ctx context.Context, obj interface{}) (model.SearchInput, error) {
	...
	fieldsInOrder := [...]string{"globalhub"}
	for _, k := range fieldsInOrder {
		...
		case "globalhub":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("globalhub"))
...
func (ec *executionContext) __Entity(ctx context.Context, sel ast.SelectionSet, obj fedruntime.Entity) graphql.Marshaler {
	...
	case model.SearchResult:
		return ec._SearchResult(ctx, sel, &obj)
	case *model.SearchResult:
		if obj == nil {
			return graphql.Null
		}
...
var searchResultImplementors = []string{"SearchResult", "_Entity"}
...
func (ec *executionContext) marshalOSearchResult2ᚕᚖgithubᚗcomᚋstolostronᚋsearchᚑv2ᚑapiᚋfederatedsearchᚋgraphᚋmodelᚐSearchResult(ctx context.Context, sel ast.SelectionSet, v []*model.SearchResult) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOSearchResult2ᚖgithubᚗcomᚋstolostronᚋsearchᚑv2ᚑapiᚋfederatedsearchᚋgraphᚋmodelᚐSearchResult(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOSearchResult2ᚖgithubᚗcomᚋstolostronᚋsearchᚑv2ᚑapiᚋfederatedsearchᚋgraphᚋmodelᚐSearchResult(ctx context.Context, sel ast.SelectionSet, v *model.SearchResult) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
