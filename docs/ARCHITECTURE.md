...
3. The DB listener receives `NOTIFY` events from [search-v2-operator subscription trigger](https://github.com/stolostron/search-v2-operator/blob/eeca830d6bc359d56d49ad6898d62a84bf5cddde/controllers/create_pgconfigmap.go#L174-L240) (a trigger on `search.resources`) and broadcasts change payloads.
